...
exports.exportsWorkerOnCreate = exports.startMembersExport = exports.startMembersExportLegacy = exports.generateMonthlyReportNow = exports.exportMonthlyReport = exports.monthlyMembershipReport = exports.cleanupExpiredData = exports.dailyRenewalReminders = exports.stripeWebhook = exports.verifyMembership = exports.clearDatabase = exports.revokeCardToken = exports.getCardKeyStatusCallable = exports.resendMembershipCard = exports.listCoupons = exports.createCoupon = exports.listOrganizations = exports.createOrganization = exports.setAutoRenew = exports.getCardToken = exports.processRenewalAutomations = exports.triggerRenewalAutomations = exports.shareDocument = exports.updateMfaPreference = exports.startAssistantSuggestion = exports.getPortalLayout = exports.getPortalDashboard = exports.getExportStatus = exports.getMyExports = exports.createPaymentIntent = exports.backfillNameLower = exports.importMembersCsv = exports.getUserClaims = exports.agentCreateMember = exports.searchUserByEmail = exports.startMembership = exports.setUserRole = exports.upsertProfile = exports.acknowledgeAlert = exports.upsertPortalLayout = exports.exportMembersCsv = void 0;
...
Object.defineProperty(exports, "upsertPortalLayout", { enumerable: true, get: function () { return portalLayouts_1.upsertPortalLayout; } });
...
Object.defineProperty(exports, "acknowledgeAlert", { enumerable: true, get: function () { return acknowledgeAlert_1.acknowledgeAlert; } });
...
exports.getMyExports = functions
    ...
    const limitRaw = Number(typeof data?.limit === 'string' || typeof data?.limit === 'number'
        ? data.limit
        : NaN);
...
exports.clearDatabase = functions
    ...
    try {
        ...
        const emuBypass = String((req.headers['x-emulator-admin'] ||
    ...
    try {
        ...
        try {
            ...
            for (const d of snapAct.docs) {
                ...
                const ms = typeof exp?.toMillis === 'function'
                    ? exp.toMillis()
    ...
    exports.seedDatabase = functions
        ...
        try {
            ...
            const upsertMember = async (uid, data) => {
                ...
                const createdAt = snapshot.exists && snapshot.get('createdAt')
...
exports.startMembersExport = functions
    ...
    try {
        ...
        const token = await firebaseAdmin_1.admin.auth().verifyIdToken(authHeader);
        ...
        const columns = (0, exportsV2_1.normalizeColumns)(Array.isArray(data?.columns)
        ...
        const { status, body } = (0, exportStatus_1.mapHttpsErrorToResponse)(error instanceof functions.https.HttpsError ? error : err);
