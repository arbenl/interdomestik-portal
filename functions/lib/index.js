    ...
    .https.onRequest(async (req, res) => {
      try {
        ...
        const ensureUser = async (createRequest) => {
          ...
          try {
            ...
            if (err.code === 'auth/email-already-exists') {
              const existing = await firebaseAdmin_1.admin
                .auth()
              ...
              if (Object.keys(updates).length > 0) {
                await firebaseAdmin_1.admin
                  .auth()
                  .updateUser(existing.uid, updates);
              }
              return existing;
            }
            throw err;
        ...
        await firebaseAdmin_1.db.collection('events').add({
          ...
          startAt: firestore_1.Timestamp.fromDate(
        ...
        for (let i = 1; i <= total; i++) {
          ...
          const createdAt = firestore_1.Timestamp.fromDate(
