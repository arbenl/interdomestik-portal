...
exports.exportsWorkerOnCreate =
  exports.startMembersExport =
  exports.startMembersExportLegacy =
  exports.generateMonthlyReportNow =
  exports.exportMonthlyReport =
  exports.monthlyMembershipReport =
  exports.cleanupExpiredData =
  exports.dailyRenewalReminders =
  exports.stripeWebhook =
  exports.verifyMembership =
  exports.clearDatabase =
  exports.revokeCardToken =
  exports.getCardKeyStatusCallable =
  exports.resendMembershipCard =
  exports.listCoupons =
  exports.createCoupon =
  exports.listOrganizations =
  exports.createOrganization =
  exports.setAutoRenew =
  exports.getCardToken =
  exports.processRenewalAutomations =
  exports.triggerRenewalAutomations =
  exports.shareDocument =
  exports.updateMfaPreference =
  exports.startAssistantSuggestion =
  exports.getPortalLayout =
  exports.getPortalDashboard =
  exports.getExportStatus =
  exports.getMyExports =
  exports.createPaymentIntent =
  exports.backfillNameLower =
  exports.importMembersCsv =
  exports.getUserClaims =
  exports.agentCreateMember =
  exports.searchUserByEmail =
  exports.startMembership =
  exports.setUserRole =
  exports.upsertProfile =
  exports.acknowledgeAlert =
  exports.upsertPortalLayout =
  exports.exportMembersCsv =
    void 0;
...
Object.defineProperty(exports, 'exportMembersCsv', {
  enumerable: true,
  get: function () {
    return exportMembersCsv_1.exportMembersCsv;
  },
});
...
const exportStatus_1 = require('./lib/exportStatus');
var portalLayouts_1 = require('./portalLayouts');
Object.defineProperty(exports, 'upsertPortalLayout', {
  enumerable: true,
  get: function () {
    return portalLayouts_1.upsertPortalLayout;
  },
});
...
var acknowledgeAlert_1 = require('./acknowledgeAlert');
Object.defineProperty(exports, 'acknowledgeAlert', {
  enumerable: true,
  get: function () {
    return acknowledgeAlert_1.acknowledgeAlert;
  },
});
...
exports.upsertProfile = functions
  ...
  .https.onCall((data, context) =>
    (0, upsertProfile_1.upsertProfileLogic)(data, context)
  );
...
exports.startMembership = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, startMembership_1.startMembershipLogic)(data, context)
  );
exports.searchUserByEmail = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, user_1.searchUserByEmailLogic)(data, context)
  );
exports.agentCreateMember = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, agent_1.agentCreateMemberLogic)(data, context)
  );
exports.getUserClaims = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, user_1.getUserClaimsLogic)(data, context)
  );
exports.importMembersCsv = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, importCsv_1.importMembersCsvLogic)(data, context)
  );
exports.backfillNameLower = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, backfill_1.backfillNameLowerLogic)(data, context)
  );
exports.createPaymentIntent = functions
  .region(REGION)
  .https.onCall((data, context) =>
    (0, payments_1.createPaymentIntentLogic)(data, context)
  );
exports.getMyExports = functions
  .region(REGION)
  .https.onCall(async (data, context) => {
    const auth = (0, exportStatus_1.requireAdminWithMfa)(context);
    ...
    const limit = Number.isFinite(limitRaw)
      ...
      : undefined;
    const jobs = await (0, exportStatus_1.listExportsForAdmin)({
      uid: auth.uid,
      limit,
    });
    return { jobs };
  });
exports.getExportStatus = functions
  .region(REGION)
  .https.onCall(async (data, context) => {
    (0, exportStatus_1.requireAdminWithMfa)(context);
    const raw = data?.id;
    const id =
      typeof raw === 'string'
        ? raw.trim()
    ...
    const record = await (0, exportStatus_1.getExportById)(id);
    if (!record) {
...
exports.startAssistantSuggestion = functions
  ...
  .https.onCall(async (data, context) => {
    try {
      return await (0, assistant_1.startAssistantSuggestionLogic)(
        data,
        context
      );
    } catch (error) {
      (0, logger_1.log)('start_assistant_suggestion_error', {
        error: String(error),
      });
      throw error;
    }
...
exports.updateMfaPreference = functions
  .region(REGION)
  .https.onCall(async (data, context) =>
    (0, security_1.updateMfaPreferenceLogic)(data, context)
  );
exports.shareDocument = functions
  .region(REGION)
  .https.onCall(async (data, context) =>
    (0, documents_1.shareDocumentLogic)(data, context)
  );
exports.triggerRenewalAutomations = functions
  .region(REGION)
  .https.onCall(async (_data, context) =>
    (0, automation_1.runRenewalHooks)(context)
  );
...
exports.setAutoRenew = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const isAdmin = context.auth.token?.role === 'admin';
    return (0, settings_1.setAutoRenewLogic)(
      context.auth.uid,
      requestedUid,
      autoRenew,
      isAdmin
...
exports.createOrganization = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const ref = await firebaseAdmin_1.db.collection('orgs').add({
      name,
      billingEmail,
      seats,
      activeSeats: 0,
...
exports.createCoupon = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    await firebaseAdmin_1.db.collection('coupons').doc(code).set(
      {
        percentOff,
        amountOff,
        active,
...
exports.resendMembershipCard = functions
  ...
  .https.onCall(async (data, context) => {
    ...
    const memberDoc = await firebaseAdmin_1.db
      .collection('members')
      .doc(uid)
      .get();
    if (!memberDoc.exists)
    ...
    if (!yearToUse) {
      const act = await firebaseAdmin_1.db
        .collection('members')
        .doc(uid)
        .collection('memberships')
        .where('status', '==', 'active')
  ...
  .https.onRequest(async (req, res) => {
    try {
      ...
      const emuBypass = String(
        req.headers['x-emulator-admin'] || req.headers['X-Emulator-Admin'] || ''
      ).toLowerCase();
      ...
      if (authHeader && authHeader.toLowerCase().startsWith('bearer ')) {
        ...
        try {
          const decoded = await firebaseAdmin_1.admin
            .auth()
      ...
      const membersSnapshot = await firebaseAdmin_1.db
        .collection('members')
        .get();
...
exports.verifyMembership = functions
  ...
  .https.onRequest(async (req, res) => {
    ...
    try {
      ...
      if (apiKey) {
        try {
          const crypto = await Promise.resolve().then(() =>
      ...
      if (!isEmu && !apiKeyValid) {
        ...
        const ip =
          ...
          'unknown';
        const crypto = await Promise.resolve().then(() =>
          __importStar(require('node:crypto'))
        );
        const hash = crypto
          .createHash('sha256')
          .update(String(ip))
      ...
      if (token && !memberNo) {
        try {
          const { verifyCardToken } = await Promise.resolve().then(() =>
            __importStar(require('./lib/tokens'))
          );
          ...
          if (claims && typeof claims.mno === 'string') {
            ...
            if (jti) {
              const revoked = await firebaseAdmin_1.db
                .collection('card_revocations')
                .doc(jti)
                .get();
              if (revoked.exists) {
  ...
  .https.onRequest(async (req, res) => {
    ...
    try {
      ...
      if (isStripeMode) {
        ...
        const Stripe = (await Function('m', 'return import(m)')('stripe'))
          .default;
        ...
        try {
          ...
          (0, logger_1.log)('stripe_webhook_signature_failed', {
            error: String(err),
          });
        ...
        const eventDoc = firebaseAdmin_1.db
          .collection('webhooks_stripe')
          .doc(event.id);
        ...
        if (event.type === 'invoice.payment_succeeded') {
          ...
          const created = firestore_1.Timestamp.fromMillis(
            (inv.created || Math.floor(Date.now() / 1000)) * 1000
          );
          await firebaseAdmin_1.db.runTransaction(async (tx) => {
            const invRef = firebaseAdmin_1.db
              .collection('billing')
              .doc(uid)
              .collection('invoices')
              .doc(invoiceId);
          ...
          try {
            await (0, startMembership_2.activateMembership)(
              uid,
              year,
              amount / 100,
              currency,
            ...
            try {
              const m = await firebaseAdmin_1.db
                .collection('members')
                .doc(uid)
                .get();
              ...
              (0, logger_1.log)('stripe_email_error', {
                error: String(e),
                uid,
              });
            }
            ...
            (0, logger_1.log)('stripe_activate_error', {
              error: String(e),
              uid,
            });
          }
      ...
      const created = body.created
        ? firestore_1.Timestamp.fromDate(new Date(body.created))
      ...
      try {
        ...
        try {
          ...
          (0, logger_1.log)('stripe_emulator_email_error', {
            error: String(e),
            uid,
          });
        }
      } catch (e) {
        (0, logger_1.log)('stripe_emulator_activate_error', {
          error: String(e),
          uid,
        });
      }
...
if (process.env.FUNCTIONS_EMULATOR) {
  exports.seedDatabase = functions
    .region(REGION)
    .https.onRequest(seed_1.seedDatabaseLogic);
}
  ...
  .onRun(async () => {
    ...
    async function runForOffset(days) {
      ...
      for (const d of q.docs) {
        ...
        await (0, membership_1.sendRenewalReminder)({
          email,
          name,
          memberNo,
          expiresOn,
      ...
      .set(
        {
          ...
          byMethod,
          updatedAt:
            firebaseAdmin_1.admin.firestore.FieldValue.serverTimestamp(),
        },
        { merge: true }
      );
  });
...
exports.exportMonthlyReport = functions
  ...
  .https.onRequest(async (req, res) => {
    ...
    const doc = await firebaseAdmin_1.db
      .collection('reports')
      .doc(`monthly-${month}`)
      .get();
    if (!doc.exists) {
...
exports.startMembersExport = functions
  ...
  .https.onRequest(async (req, res) => {
    ...
    try {
      ...
      const token = await firebaseAdmin_1.admin
        .auth()
        .verifyIdToken(authHeader);
      await (0, exportStatus_1.ensureAdminMfaForToken)(token);
      const actor = token.uid;
      const running = await firebaseAdmin_1.db
        .collection('exports')
      ...
      const filters = {
        regions: Array.isArray(data?.filters?.regions)
          ? data.filters.regions.map((x) => String(x)).filter(Boolean)
          : undefined,
      ...
      const columns = (0, exportsV2_1.normalizeColumns)(
      ...
      try {
        const { rows, size, url } = await (0, exportsV2_1.streamMembersCsv)({
      ...
      (0, logger_1.log)('start_members_export_error', {
        error: err.message,
        code,
      });
      const { status, body } = (0, exportStatus_1.mapHttpsErrorToResponse)(
