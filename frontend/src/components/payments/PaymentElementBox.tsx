  ...
  async function confirm() {
    ...
    try {
      ...
      if (
        ...
        push({
          type: 'success',
          message: 'Payment succeeded. Membership will activate shortly.',
        });
      } else {
    ...
    return (
      <div className="border rounded p-4 bg-yellow-50">
        ...
        <div className="text-sm text-gray-700">
          No `VITE_STRIPE_PUBLISHABLE_KEY` configured. Use the emulator webhook
          button below to simulate a paid invoice.
        </div>
      </div>
    );
  }
    ...
    <div className="border rounded p-4 bg-white">
      ...
      {succeeded && (
        <div className="mt-3 border rounded p-3 bg-green-50 text-green-800">
          Payment succeeded. Your membership will be activated shortly, and your
          digital card sent by email.
        </div>
      )}
    </div>
  );
