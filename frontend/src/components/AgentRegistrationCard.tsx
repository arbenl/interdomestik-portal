...
export default function AgentRegistrationCard({ allowedRegions, onSuccess, onError }: AgentRegistrationProps) {
    ...
    <div className="bg-white shadow rounded-lg p-4 mb-6">
      ...
      <form onSubmit={(e) => { void onSubmit(e); }} className="grid grid-cols-1 md:grid-cols-5 gap-3">
        ...
        <div className="md:col-span-5 flex justify-end">
          <button type="submit" disabled={!canSubmit} className="bg-indigo-600 text-white px-4 py-2 rounded disabled:opacity-50">
