...
export function CouponsPanel({ push }: { push: (t: { type: 'success' | 'error'; message: string }) => void }) {
  ...
  return (
    <div className="mb-6 p-4 border rounded bg-white">
      ...
      <div className="flex gap-2 items-end mb-3">
        ...
        <Button disabled={isLoading || !code} onClick={() => { void handleCreate(); }}>Save Coupon</Button>
      </div>
