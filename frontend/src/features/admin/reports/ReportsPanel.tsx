    ...
    >
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600">
          Review recent membership trends across the organisation.
        </p>
      </div>
          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              ...
              {rows.map((report) => {
                ...
                const members =
                  typeof report.total === 'number' ? report.total : '—';
                const updatedAt = report.updatedAt?.seconds
                  ? new Date(
                      report.updatedAt.seconds * 1000
                    ).toLocaleDateString()
                  : '—';
                return (
